...
class FetchCustomer1 extends React.Component {
    constructor(props) {
    ...
    componentDidMount() {
        ...
        $.getJSON('Customer/Index', function (data) {
    ...
    renderForm() {
        ...
        if( (this.state.items.length == 0)|| (jsonRet.length==0)){ }
            ...
            return (
                ...
                <Fragment>
                    <div className='divpad'>  <Button className="btn btn-primary" onClick={(e) => this.handleCreate1(e)}> Create New Customer</Button>
                        <div>
...
export default withRouter(FetchCustomer1);
